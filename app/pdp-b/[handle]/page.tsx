import { StunnViewProduct } from "components/analytics-beacon";
import { MetaViewContent } from "components/meta-pixel";
import { StunnPurchasePanelB } from "components/product/stunn-purchase-panel-b";
...
// Variant B of the PDP — a preview for internal review, not a public page.
    ...
    <PurchaseSelectionProvider initialQty={1}>
      ...
      <div className="relative lg:flex lg:items-start">
        ...
        <div id="purchase" className="lg:w-1/2">
          ...
          >
            <StunnPurchasePanelB product={product} />
          </Suspense>
        </div>
      </div>
