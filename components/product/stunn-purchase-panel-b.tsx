...
export function StunnPurchasePanelB({ product }: { product: Product }) {
  ...
  return (
    <div className="px-6 py-6 pb-20 lg:px-10 lg:py-8 lg:pb-8">
            ...
            >
              ...
              <div className="min-w-0">
                ...
                <span className="mt-0.5 block text-[10px] font-medium leading-tight text-[#111111]/55 sm:text-[11px]">
                  (
                  {formatPerDay(perDay(v.retailPrice, v.count), {
                    spaced: true,
                    unit: "Day",
                  })}
                  )
      ...
      {/* PRIMARY — one-time purchase. Lowest-friction entry for cold traffic:
          no commitment, no recurring charge, single box by default. */}
